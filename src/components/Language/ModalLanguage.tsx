...
import EnglandFlag from '@/config/SVG/Flags/EnglandFlag';
import FranceFlag from '@/config/SVG/Flags/FranceFlag';
import GermanFlag from '@/config/SVG/Flags/GermanFlag';
import ItalyFlag from '@/config/SVG/Flags/ItalyFlag';
import PortugalFlag from '@/config/SVG/Flags/PortugalFlag';
import RussiaFlag from '@/config/SVG/Flags/RussiaFlag';
import SpainFlag from '@/config/SVG/Flags/SpainFlag';
